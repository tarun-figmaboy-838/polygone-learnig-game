...
| | |
| --- | --- |
| ✅ | All **31 screens** present, in storyboard order, each with a unique id |
...
| ✅ | Instruction card simulated on all 31 screens; every screen says what to do |
...
npm run test:browser  the same 31 screens in a real Chrome, ~105 s
```
